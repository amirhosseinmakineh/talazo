...
const roleRepository_1 = require("../../infra/repositories/roleRepository");
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [auth_controller_1.AuthController, user_controller_1.UserController, role_controller_1.RoleController],
        providers: [
            ...
            { provide: "IRoleService", useExisting: roleService_1.RoleService },
            ...
            { provide: "IRoleRepository", useExisting: roleRepository_1.RoleRepository },
        ],
