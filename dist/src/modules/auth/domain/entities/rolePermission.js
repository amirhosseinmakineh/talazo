...
__decorate([
    (0, typeorm_1.ManyToOne)(() => role_1.Role, (r) => r.rolePermissions, { onDelete: "CASCADE" }),
    (0, typeorm_1.JoinColumn)({ name: "roleId" }),
    __metadata("design:type", role_1.Role)
], RolePermission.prototype, "role", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => permission_1.Permission, (p) => p.rolePermissions, { onDelete: "CASCADE" }),
